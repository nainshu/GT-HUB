...
-- 检查是否已经存在密码输入界面，如果存在则销毁它
local existingPasswordGui = game.Players.LocalPlayer.PlayerGui:FindFirstChild("PasswordGui")
if existingPasswordGui then
    existingPasswordGui:Destroy()
end
